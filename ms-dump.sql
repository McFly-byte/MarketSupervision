...
CREATE TABLE `equipment` (
  ...
  `registrationNumber` varchar(255) NOT NULL COMMENT '使用登记证编号',
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `equipment_pk` (`registrationNumber`)
...
INSERT INTO `equipment` VALUES (1,'电动单梁起重机','41702156120190307','起17辽JG0033(24)','LD5—23.5 A3','车间','xxxx铸造有限公司','起重机','2019.03.07','2019-04-20','2023-04-26','','2025-04-25','2025-02-16 10:48:28',NULL,NULL,NULL),(2,'液压机','1234646','1556465','15465456','554656','lixadha','高压设备','4464646','2025-02-17','2025-02-17','','2025-02-17','2025-02-17 12:19:28',NULL,NULL,NULL),(3,'equip1','code1','number1','version',NULL,'companyName',NULL,NULL,'2025-02-20','2025-02-20',NULL,'2026-02-20','2025-02-19 21:06:57',NULL,NULL,NULL),(4,'equip2','code2','number2',NULL,NULL,'companyName',NULL,NULL,'2025-02-20','2025-02-20',NULL,'2026-02-20','2025-02-20 12:36:03',NULL,NULL,NULL),(5,'桥式起重机','41702156120001','起17辽JG0001','LD5—23.5 A3','车间二','companyName','压力容器','2019.03.02','2025-02-19','2025-02-19',NULL,'2026-02-19','2025-02-20 16:24:14',1,0,NULL),(6,'塔式起重机','41702156120002','起17辽JG0002','LD5—23.5 A3','车间三','companyName','电梯','2019.03.03','2025-02-19','2025-02-19',NULL,'2026-02-19','2025-02-20 16:24:14',1,0,NULL),(7,'equipment','code','number','version',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2025-02-20 19:58:16',NULL,NULL,NULL);
...
INSERT INTO `register_user` VALUES (1000017,'register_user','company','$2a$10$/4uKc8HuDSuU4WMAX5Scq.Rp5JXI.jZx3FP3EKFgQ2ft5EW5COlmG','2025-02-20 19:58:16','region');
...
-- Dump completed on 2025-02-22 21:01:18
